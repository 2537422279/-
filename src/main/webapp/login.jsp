...
<head>
    ...
    <script>
        window.onload=function(){
            let oSwitch_login=document.getElementById('switch_login');
            let oSwitch_regist=document.getElementById('switch_regist');
            let oQlogin=document.getElementById('qlogin');
            let oQregist=document.getElementById('qregist');
            let oSwitch_bottom=document.getElementById('switch_bottom');
...
<body style="background:#00a4ac no-repeat;">
<div class="container">
        ...
        <div class="qlogin" id="qlogin">
            <div class="web_login" align="center">
                <form action="${pageContext.request.contextPath}/login" method="post"  onsubmit="return checkValue()">
                    <font style="color:#ff0000;font-size:16px;">${requestScope.msg}</font>
